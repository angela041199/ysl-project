                                        ...
                                        <ul class="dropdown-menu">
                                            <?php foreach ($filterCategory as $type) : ?>
                                                <li class="dropdown-item <?php echo isset($_GET['type']) && $_GET['type'] == $type['id'] ? 'active' : ''; ?>">
                                                    <a class="no_link" href="edit_product.php?<?= $filterString ?>&type=<?= $type['id'] ?>">
                                                        <?= $type["type_name"] ?>
                                                    </a>
                                                </li>
                                            <?php endforeach; ?>
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php foreach ($filterRating as $rating) : ?>
                                                <li class="dropdown-item <?php echo isset($_GET['rating']) && $_GET['rating'] == $rating['id'] ? 'active' : ''; ?>">
                                                    <a class="no_link" href="edit_product.php?<?= $filterString ?>&rating=<?= $rating['id'] ?>">
                                                        <?= $rating["rating_name"] ?>
                                                    </a>
                                                </li>
                                            <?php endforeach; ?>
                            ...
                            <table class="table">
                                <thead class="table-warning">
                                    <tr>
                                        ...
                                        <th>分級</th>
                                        <th>支援語言</th>
                                        <th>價格<a href="edit_product.php?priceDown&<?= $filterString ?>"><i class="bi bi-caret-down-fill"></i></a>
                                            <a href="edit_product.php?priceUp&<?= $filterString ?>"><i class="bi bi-caret-up-fill"></i></a>
                                        </th>
                                        <th>上架時間
                                            <a href="edit_product.php?<?= $filterString ?>&doDown"><i class="bi bi-caret-down-fill"></i></a>
                                            <a href="edit_product.php?<?= $filterString ?>&doUp"><i class="bi bi-caret-up-fill"></i></a>
                                        </th>
                                        <th>商品狀態 / 資訊</th>
                                    </tr>
                                </thead>
