                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($searchResult as $row): ?>
                                        <tr>
                                            <td>
                                                <figure class="img"><img class="ob_fit" src="images/<?= $row["img"] ?> "
                                                        alt="<?= $row["name"] ?>"></figure>
                                            </td>
                                            <td>
                                                <?= $row["name"] ?>
                                            ...
                                            <td>
                                                <input id="cb5" class="tgl.tgl-flip" type="checkbox">
                                                <label class="tgl-btn" data-tg-off="公開" , data-tg-on="隱藏" , for="cb5">
                                                </label>
                                                </input>
                                ...
                                <ul class="pagination">
                                    <li class="page-item <?php echo ($page == 1) ? 'disabled' : ''; ?>">
                                        <a title="上一頁" class="page-link"
                                            href="search.php?page=<?php echo $page - 1; ?><?php echo filterQuery(); ?>"
                                            aria-label="Previous">
                                    ...
                                    for ($i = 1; $i <= $totalPagesToShow; $i++): ?>
                                        <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                                            <a class="page-link"
                                                href="search.php?page=<?php echo $i; ?><?php echo filterQuery(); ?>">
                                                <?php echo $i; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
