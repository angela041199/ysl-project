...
<nav class="sb-topnav navbar navbar-expand navbg">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3 text-white" id="logo" href="../seller/seller_dashboard.php"><img class="ob_fit" src="../style/img/ysl-logo-blue-button-whiteborder.png" alt="LOGO"></a>  
    <!-- Sidebar Toggle-->
