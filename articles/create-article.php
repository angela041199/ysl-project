                    ...
                    <div class="container-fluid px-4">
                        <section class="main-header">
                            <div class="title">
                                ...
                                <input type="text" name="title" placeholder="請輸入文章標題..." value=""><i class="fa-solid fa-circle-info" style="color: #8a8e93;" title="文章標題"></i>
                            </div>
                            ...
                            <section class="main">
                                ...
                                <div class="right-wrap">
                                    ...
                                    <div class="cover-img-wrap shadow-sm">
                                        <label for="imageUpload" class="form-label">文章預覽圖設定 <i class="fa-solid fa-circle-info" style="color: #8a8e93;"></i></label>
                                        <br>
                                        <!-- 圖片上傳按鈕 -->
