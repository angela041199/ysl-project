                        ...
                        <section class="main-header create-header">
                            <div class="title">
                                ...
                                <input type="text" name="title" placeholder="請輸入文章標題..." value=""><i
                                    class="fa-solid fa-circle-info" style="color: #a52a2a;" title="文章標題，請務必填寫"></i>
                            </div>
                                ...
                                <div class="editor-wrap shadow-sm">
                                    <div class="mb-3">
                                        <label class="form-label category-input">文章分類 <i class="fa-solid fa-circle-info"
                                                style="color: #8a8e93;" title="請選擇要發佈文章的所屬分類類型"></i><span
                                                class="info-text">必填欄位</span></label>
                                ...
                                <div class="right-wrap">
                                    ...
                                    <div class="cover-img-wrap shadow-sm">
                                        <label for="imageUpload" class="form-label">文章預覽圖設定 <i
                                                class="fa-solid fa-circle-info" style="color: #8a8e93;"></i><span
                                                class="info-text">必填欄位</span></label>
                                        <br>
                                        <!-- 圖片上傳按鈕 -->
