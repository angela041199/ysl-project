                        ...
                        <div class="container-fluid px-4">
                            ...
                            <section class="main-header">
                                <div class="title">
                                    ...
                                    <input type="text" name="title" placeholder="請輸入文章標題..." value="<?= $article['title'] ?>"><i class="fa-solid fa-circle-info" style="color: #8a8e93;" title="文章標題"></i>
                                </div>
                                <div class="button-wrap">
                                    ...
                                    <?php if ($article['status_id'] == 1) : ?>
                                        ...
                                        <button class="btn btn-warning text-white" value="unpublish" type="submit" name="action">下架</button>
                            ...
                            <section class="wrapper">
                                ...
                                <section class="main">
                                    <div class="editor-wrap shadow-sm">
                                        <div class="mb-3">
                                            <label class="form-label category-input">文章分類 <i class="fa-solid fa-circle-info" style="color: #8a8e93;" title="請選擇要發佈文章的所屬分類類型"></i></label>
                                            <select class="form-select" name="category_id">
                                                <option class="<?php if (!isset($article['category_id'])) echo 'selected'; ?>">
                                                    請選擇文章分類
                                                </option>
                                                <option value="1" <?php if ($article['category_id'] == 1) echo 'selected'; ?> name="">
                                                    遊戲攻略
                                                </option>
                                        ...
                                        <div id="container">
                                            <label class="form-label">文章內容 <i class="fa-solid fa-circle-info" style="color: #8a8e93;" title="請輸入文章內容"></i></label>
                                    ...
                                    <div class="right-wrap">
                                        <div class="status-wrap shadow-sm">
                                            <p>文章狀態 <i class="fa-solid fa-circle-info" style="color: #8a8e93;" title="當前文章狀態"></i></p>
                                            <div class="<?= $article['status_id']==1 ? 'publish' : 'unpublish'; ?>"><?= $article['status_name'] ?></div>
                                        </div>
                                        <div class="author-wrap shadow-sm">
                                            <p>作者設定 <i class="fa-solid fa-circle-info" style="color: #8a8e93;" title="請輸入作者名稱"></i></p>
                                            <label class="form-label">作者名字</label>
                                            <input type="text" class="form-control" value="<?= $article['author_name'] ?>" name="author">
                                        </div>
                                        <div class="cover-img-wrap shadow-sm">
                                            <label for="imageUpload" class="form-label">文章預覽圖設定 <i class="fa-solid fa-circle-info" style="color: #8a8e93;" title="圖檔大小上限為5MB，請盡量使用.jpg檔"></i></label>
                                            <br>
                                            <!-- 圖片上傳按鈕 -->
